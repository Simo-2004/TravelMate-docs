...
The diagrams show the classes of the **delivered** system. Trip creation and editing, group membership and moderation belong to the deferred requirements of [RAD 3.2](../../rad/proposed-system/functional) and have no classes here. Full signatures, types, visibility and contracts belong to the [ODD](../../odd/class-interfaces/).
