...
features:
  ...
  - icon:
      dark: /icons/sdd-dark.svg
      light: /icons/sdd-light.svg
      width: 48
      height: 48
  ...
  - icon:
      dark: /icons/odd-dark.svg
      light: /icons/odd-light.svg
      width: 48
      height: 48
  ...
  - icon:
    ...
    details: Complete API reference for internal services, data persistence layer, and future backend REST API specifications.
    link: /api-examples
